...
IDLE — v1.67.1 merged (PR #57, 2026-09-23), branch deleted, origin pruned. PR #58 open (docs/v1.68.0-doc-batch) — items 1-3, doc-only, CI green, awaiting review. Stale origin/feat/v1.68.0-batch (pre-rebase) can be deleted once #58 merges. See BL-001.
