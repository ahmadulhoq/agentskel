# agentskel — Antigravity Instructions

Read and follow all rules in `.agent/rules/` before starting any task.
...
Key files:
- `MASTER_PLAN.md` — ADR: full system design, architecture rationale, every decision and why
