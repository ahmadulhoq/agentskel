...
You are setting up **agentic development infrastructure** on this project.

Your goal is to wire up everything needed so an AI agent can work effectively on this codebase:
memory files, rules, workflows, skills, CLAUDE.md, and CODEOWNERS.

**This is a setup mission — you are not writing any application code.**
